...
void display0()
{
	...
	drawText(300, 235, "Prof. Sahana Damale", 2);
	drawText(700, 235, "Prof. Sasidhar B", 2);
...
}void display7()
{
	...
	for(int i=0; i<6500; i++)
	{
		...
		if(i==6100 || i==6150 || i==6200 || i==6250 || i==6300 || i==6350 || i==6450)
		{
			for(int x=0; x<20000; x++)
				for(int y=0; y<40000; y++);
		}
